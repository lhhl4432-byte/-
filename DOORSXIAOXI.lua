...
local Window = Library:CreateWindow({
    Title = "<font color='#FFFFFF'>X</font><font color='#D9D9D9'>I</font><font color='#B3B3B3'>A</font><font color='#8C8C8C'>O</font><font color='#666666'>X</font><font color='#404040'>I</font> <font color='#8C8C8C'>|</font> <font color='#666666'>D</font><font color='#404040'>O</font><font color='#FFAEC4'>O</font><font color='#404040'>R</font><font color='#FFAEC4'>S</font><font color='#404040'></font>",
    Footer = "<font color='#FFFFFF'>X</font><font color='#D9D9D9'>I</font><font color='#B3B3B3'>A</font><font color='#8C8C8C'>O</font><font color='#666666'>X</font><font color='#404040'>I</font> <font color='#8C8C8C'>|</font> <font color='#666666'>D</font><font color='#404040'>O</font><font color='#FFAEC4'>O</font><font color='#404040'>R</font><font color='#FFAEC4'>S</font><font color='#404040'></font>",
...
IntroductionGroup:AddLabel("作者: byBkFd")
IntroductionGroup:AddLabel("共同作者: YG")
IntroductionGroup:AddLabel("功能提供作者: Yuxingchen")

local ChangelogsGroup = Tabs.Home:AddRightGroupbox("公告")
ChangelogsGroup:AddLabel('<font color="rgb(0,255,0)"> XIAOXI  | 作者QQ号🐧：3996245464</font>')
ChangelogsGroup:AddLabel('<font color="rgb(0,255,0)"> XIAOXI  | QQ下载🐧：</font>')

ChangelogsGroup:AddButton({
    Text = "复制作者qq号",
    Func = function()
        pcall(function()
            setclipboard("3996245464")
        end)
        Library:Notify({
            Title = "bsgm73 HUB",
            Description = "已复制作者qq号",
            Time = 3,
            SoundId = 6026984224,
        })
    end,
...
ChangelogsGroup:AddButton({
    ...
    Func = function()
        pcall(function()
            setclipboard("https://im.qq.com/immobile/#/")
        end)
        Library:Notify({
            Title = "bsgm73 HUB",
            Description = "已复制qq下载链接",
            Time = 3,
            SoundId = 6026984224,
        })
    end,
...
MovementGroup:AddSlider('WalkspeedAmount', {
    ...
    local function updateWatermark()
        ...
        game:GetService('RunService').RenderStepped:Connect(function()
            ...
            Library:SetWatermark(string.format('XIAOXI HUB | %d FPS | byBkFd | %d ping', math.floor(fps), math.floor(game:GetService('Stats').Network.ServerStatsItem['Data Ping']:GetValue())))
        end)
    end
